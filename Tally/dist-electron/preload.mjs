...
electron.contextBridge.exposeInMainWorld("dbDAO", {
  ...
  getAllInactiveTallyBoards: () => electron.ipcRenderer.invoke("get-inactiveBoards"),
  deleteBoardByID: (id) => electron.ipcRenderer.invoke("delete-boardById", id),
  permDeleteBoardByID: (id) => electron.ipcRenderer.invoke("permDelete-boardById", id),
  recoverBoardByID: (id) => electron.ipcRenderer.invoke("recover-boardById", id),
