...
contextBridge.exposeInMainWorld('dbDAO', {
  ...
  getAllInactiveTallyBoards: () => ipcRenderer.invoke('get-inactiveBoards'),
  deleteBoardByID: (id: number) => ipcRenderer.invoke('delete-boardById', id),
  permDeleteBoardByID: (id: number) => ipcRenderer.invoke('permDelete-boardById', id),
  recoverBoardByID: (id: number) => ipcRenderer.invoke('recover-boardById', id),
